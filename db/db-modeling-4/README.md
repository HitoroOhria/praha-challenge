...
- [課題1](#%E8%AA%B2%E9%A1%8C1)
    ...
    - [回答の補足](#%E5%9B%9E%E7%AD%94%E3%81%AE%E8%A3%9C%E8%B6%B3)
      - [各テーブルの説明](#%E5%90%84%E3%83%86%E3%83%BC%E3%83%96%E3%83%AB%E3%81%AE%E8%AA%AC%E6%98%8E)
      ...
      - [バッチのリマンド処理](#%E3%83%90%E3%83%83%E3%83%81%E3%81%AE%E3%83%AA%E3%83%9E%E3%83%B3%E3%83%89%E5%87%A6%E7%90%86)
      - [タスクの追加処理](#%E3%82%BF%E3%82%B9%E3%82%AF%E3%81%AE%E8%BF%BD%E5%8A%A0%E5%87%A6%E7%90%86)
      - [タスクの更新処理](#%E3%82%BF%E3%82%B9%E3%82%AF%E3%81%AE%E6%9B%B4%E6%96%B0%E5%87%A6%E7%90%86)
...
1. Redis から現在時刻をキーに指定して、送信対象のタスクID一覧を取得
2. DB からタスクIDに一致するタスクを取得
3. アプリケーションでタスクのアサインメンバーに対してリマンドを送信

#### タスクの追加処理

1. Redis にリマインド送信日時をキーにして、タスクIDを追加 (10年先くらいまで一度に入れる、`RPOP` コマンド & Mass Insert)
2. DB にタスクのデータを保存

#### タスクの更新処理

1. Redis から更新前のリマンド送信日時のキーから、更新タスクIDを削除 (`LREM` コマンド & Mass Insert)
2. Redis にリマインド送信日時をキーにして、タスクIDを追加 (10年先くらいまで一度に入れる、`RPOP` コマンド & Mass Insert)
3. DB のタスクのデータを更新
